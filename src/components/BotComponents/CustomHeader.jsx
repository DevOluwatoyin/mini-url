...
const CustomHeader = () => {
  ...
  const { setButtonStyle, setBotPosition } = useContext(BotContext);

  const handleButtoClick = (text) => {
    setBotPosition(text);
    setOpenDropdown(false);
  };

  return (
    <div className="p-[12.5px] bg-[#efefef] text-[#514f4f] font-bold text-sm flex items-center justify-between relative">
      <header>Scissor Customer Support</header>
      ...
      <div className="">
        ...
        {openDropdown && (
          <div className="absolute font-normal p-4 text-xs text-black w-60 bg-white right-0 z-[2] space-y-5">
            ...
            <ul className="list-disc list-inside">
              <li>
                <button
                  className="py-2 px-1 hover:bg-gray-300"
                  onClick={() => {
                    handleButtoClick("bottom-8 right-4 items-end");
                    setButtonStyle("align-self-end");
                  }}
                >
              ...
              <li>
                <button
                  className="py-2 px-1 hover:bg-gray-300"
                  onClick={() => {
                    handleButtoClick("bottom-8 left-4 items-start");
                    setButtonStyle("align-self-start");
                  }}
                >
                  Bottom left
                </button>
              ...
              <li>
                <button
                  ...
                  onClick={() => {
                    handleButtoClick(
                      "top-8 left-4 flex-col-reverse items-start"
                    );
                    setButtonStyle("align-self-start");
                  }}
                >
